...
@SpringBootTest
public class UseMPGenerateCode {
    @Test
    public void codeGenerator() {
        FastAutoGenerator.create("jdbc:mysql://192.168.56.1:3307/giot_trade?useSSL=false&serverTimezone=Asia/Shanghai", "root", "123456")
                ...
                .strategyConfig(builder -> {
                    builder.addTablePrefix("trade_") // 设置过滤表前缀
                            .entityBuilder()
